		...
		<div class="container">
			<div class="agileinfo_footer_grids">
				<div class="col-md-4 agileinfo_footer_grid">
					...
					<p>A proudly Canadian craft beer company. The goto place for
                         purchasing high quality craft beer from breweries across Canada.
					</p>
				...
				<div class="col-md-4 agileinfo_footer_grid">
					...
					<ul class="agileinfo_footer_grid_list">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Algonquin College</li>
			...
			<div class="w3agile_footer_copy">
				<p>&copy; 2017 Da Pint. All rights reserved </p>
			</div>
		</div>
	</div>
