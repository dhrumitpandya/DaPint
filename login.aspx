    ...
    <form id="form1" runat="server" class="login-overlay">
        <div class="container login-container">
            ...
            <div>
                ...
                <p style="font-size:11px; display:inline-block; position:relative; top: 1px;color:aquamarine;">remember me</p><input class="checkbox-inline" style="display:inline-block; width: 30px;" type="checkbox"/>
            </div>
